...
if __name__ == "__main__":
    ...
    Q = np.diag((10,10))                # the covariance of the process noise
    ...
    for t in range (0,N_iter):
        ...
        w1=np.random.uniform(0, np.sqrt(10), 1)
        w2=np.random.uniform(0, np.sqrt(10), 1)
        
        # process noise
        W =np.array([[w1[0]],[w2[0]]])
    
        e=np.random.uniform(0, np.sqrt(6), 1)
    ...
    for i in range(N_iter):
        ...
        Pgrow.append((outputP[i][0][0]+outputP[i][1][1])/2)
        Kgrow.append((outputK[i][0][0]+outputP[i][1][1])/2)
        Ygrow.append(outputY_hat[i][0])
